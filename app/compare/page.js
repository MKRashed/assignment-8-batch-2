...
export default function CompareMovies() {
  ...
  const handleMovieSelect = (selectedMovie) => {
      setMovieSlots(
          movieSlots.map((slot) =>
              slot.id === currentSlotId ? { ...slot, movie: selectedMovie } : slot
          )
      );
                  ...
                  <div className="grid grid-cols-5 gap-8">
                      <div className="col-span-2">
                          <Image
                              ...
                              height={350}
                          />
                          <h2 className="text-xl font-bold mb-2 text-center">{slot.movie.title}</h2>
                      </div>
                      <div className="w-full space-y-4 col-span-3">
                          ...
                          <div className="bg-zinc-800 p-3 rounded">
                              ...
                              <span className="float-right">{slot.movie.release_date?.slice(0, 4)}</span>
                          </div>
                          <div className="bg-zinc-800 p-3 rounded">
